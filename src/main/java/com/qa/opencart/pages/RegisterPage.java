...
public boolean registerUser(String firstName,String lastname,String email,String telephone,String password,String subscribe) {
   ...
   String successMessg= eleUtil.waitForElementVisible(registerSuccessMesg, AppConstants.DEFAULT_MEDIUM_TIME_OUT).getText();
   System.out.println("user registration success message :" +successMessg);
